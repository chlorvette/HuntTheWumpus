...
partial class TriviaCorrect : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("TriviaCorrect");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named TriviaCorrect - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new TriviaCorrect(visual);
            visual.Width = 0;
        ...
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(TriviaCorrect)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("TriviaCorrect", () => 
        {
    ...
    public TriviaCorrect(InteractiveGue visual) : base(visual)
    {
    }
    public TriviaCorrect()
    {
